 ...
 */
public class ProvinciasProvider extends BBDDbase{

    public static JSONObject json;

    public static void GetAllProvincias(final OnJSONResponseCallback callback, String token){
        String url = UrlsAPI.PROVINCIA;
